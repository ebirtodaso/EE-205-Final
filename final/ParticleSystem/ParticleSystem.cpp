...
ParticleSystem::ParticleSystem(StateManager* l_stateManager, TextureManager* l_textureManager, RandomNumberGenerator* l_rand, Map* l_map)
...
RandomNumberGenerator* ParticleSystem::GetRand() const { return m_rand; }
