...
{
	std::ifstream file;
	file.open(Utilibros::GetWorkingDirectory() + "media/GUI_Interfaces/" + l_interface);
...
bool GUI_Manager::LoadInterface(GUI_Interface* l_interface, const std::string& l_fileName) {
	std::ifstream file;
	file.open(Utilibros::GetWorkingDirectory() + "media/GUI_Interfaces/" + l_fileName);
	std::string InterfaceName;
...
bool GUI_Manager::LoadStyle(const std::string& l_file, GUI_Element* l_element) {
	std::ifstream file;
	file.open(Utilibros::GetWorkingDirectory() + "media/GUI_Styles/" + l_file);
