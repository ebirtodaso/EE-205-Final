...
void MainMenuState::initGui()
{
	...
	this->buttons["GAME_STATE"] = new gui::Button(
		gui::p2pX(43.5f, vm), gui::p2pY(50.f, vm), 
	...
	this->buttons["LOAD_STATE"] = new gui::Button(
		gui::p2pX(43.5f, vm), gui::p2pY(57.f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
		&this->font, "Load Game", gui::calcCharSize(vm),
		sf::Color(200, 200, 200, 200), sf::Color(255, 255, 255, 255), sf::Color(20, 20, 20, 50),
		sf::Color(70, 70, 70, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0)
	);

	this->buttons["SETTINGS_STATE"] = new gui::Button(
		gui::p2pX(43.5f, vm), gui::p2pY(64.f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
	...
	this->buttons["EXIT_STATE"] = new gui::Button(
		gui::p2pX(43.5f, vm), gui::p2pY(71.f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
